...
class _ForSaleItemCardState extends State<ForSaleItemCard> {
  ...
  NormalCardModel _cardModel = NormalCardModel('بندورة ','assets/test.png','2.00' ,'كيلو غرام');
              ...
              children: <Widget>[
                Expanded(
                  ...
                  child: Padding(
                    ...
                    child: Container(
                      child: Image(image: AssetImage(widget.cardInfo[widget.index].image),),
                ...
                Expanded(
                  ...
                  child: Container(
                    ...
                    child: Text(widget.cardInfo[widget.index].productName,
                      style: TextStyle(
                ...
                Expanded(
                  ...
                  child: Container(
                    ...
                    child: Text(widget.cardInfo[widget.index].price,
                    style: TextStyle(
                ...
                child: Container(
                  ...
                  child: Text(widget.cardInfo[widget.index].amount ,
                 style: TextStyle(
                     fontSize: 15.0,
                   fontWeight: FontWeight.bold,
                 ),
